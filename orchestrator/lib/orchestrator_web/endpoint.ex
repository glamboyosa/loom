defmodule OrchestratorWeb.Endpoint do
  @moduledoc """
  Phoenix endpoint for the Loom orchestrator web interface.

  Provides:
  - HTTP API endpoints for workflow management
  - WebSocket channels for real-time log streaming
  - Static file serving for the SvelteKit UI
  """
  ...
  @session_options [
    ...
    signing_salt: "orchestrator_salt"
  ]
